...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-[1990] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/20 transition-transform duration-300 hover:scale-105"
    >
